...
function HQMainPanel( { filteredRows, isFiltered }) {
  ...
  return (
      <div>
        ...
        {/*  <table className="table table-bordered  overflowY: 'auto'">*/}
        {/*    <thead className="table-info">*/}
        {/*    <tr>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0"   rowSpan="2" style={{width: '130px', height: '60px', backgroundColor: "#CFE2FF"}}>주문번호</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0"  rowSpan="2" style={{width: '130px', height: '60px', backgroundColor: "#CFE2FF"}}>대리점 ID</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0" colSpan="2" style={{backgroundColor: "#CFE2FF"}}>일자</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0"  rowSpan="2"  style={{width: '130px', backgroundColor: "#CFE2FF"}}>가격</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0"  rowSpan="2" style={{width: '130px', backgroundColor: "#CFE2FF"}}>주문현황</th>*/}
        {/*    </tr>*/}
        {/*    <tr>*/}
        {/*      <th className="text-center align-middle sticky-th-top-60" style={{width: '130px', backgroundColor: "#CFE2FF"}}>주문일자</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-60" style={{width: '130px', backgroundColor: "#CFE2FF"}}>도착일자</th>*/}
        {/*    </tr>*/}
        {/*    </thead>*/}
        ...
        {/*            <tr key={i} onClick={() => {*/}
        {/*              console.log('row clicked:', row.orderId);*/}
        ...
        {/*    <thead className="table-info">*/}
        {/*    <tr>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0" style={{backgroundColor: "#CFE2FF"}}  rowSpan="2">주문번호</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0" style={{backgroundColor: "#CFE2FF"}}  rowSpan="2">대리점 ID</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0" style={{backgroundColor: "#CFE2FF"}} colSpan="2">일자</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0" style={{backgroundColor: "#CFE2FF"}} rowSpan="2">가격</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-0" style={{backgroundColor: "#CFE2FF"}} rowSpan="2">주문현황</th>*/}
        {/*    </tr>*/}
        {/*    <tr>*/}
        {/*      <th className="text-center align-middle sticky-th-top-60" style={{backgroundColor: "#CFE2FF"}}>주문일자</th>*/}
        {/*      <th className="text-center align-middle sticky-th-top-60" style={{backgroundColor: "#CFE2FF"}}>도착일자</th>*/}
        {/*    </tr>*/}
        {/*    </thead>*/}
        {/*  </table>*/}
              ...
              <div className="p-4 mt-3 bg-light w-100 overflow-auto" style={{ maxHeight: '400px', overflowY: 'auto' }}>
                ...
                <table className="table table-bordered sticky-table">
                  ...
                  <tr>
                    ...
                    <th className="text-center align-middle" rowSpan="2" style={{width: '130px', height: '60px', backgroundColor: "#CFE2FF"}}>대리점 ID
                    </th>
                    ...
                    <th className="text-center align-middle" rowSpan="2" style={{width: '130px', backgroundColor: "#CFE2FF"}}>주문일자</th>
                  </tr>
                  <tr>
                    <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>부품 Code</th>
                    <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>부품명</th>
                    <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>수량</th>
                    <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>비용</th>
                  </tr>
                  </thead>
                  <tbody>
                  {rows2.length === 0 ? (
                ...
                <div className="mt-3 text-end">
                  <button className={'btn'} style={{backgroundColor: "#CFE2FF"}} type={"button"} onClick={handleOpenModal}>결재</button>
                </div>
...
//           </table>
//
//           <div style={{maxHeight: '340px', overflowY: 'auto', width:'1633px'}}>
//             <table className="table table-bordered" style={{tableLayout: 'fixed', width: '100%'}}>
//               <colgroup>
//                 <col style={{width: '130px'}}/>
//                 <col style={{width: '130px'}}/>
...
//                         style={{width: '130px', height: '60px', backgroundColor: "#CFE2FF"}}>대리점 ID
//                     </th>
//                     <th className="text-center align-middle" colSpan="2" style={{backgroundColor: "#CFE2FF"}}>부품</th>
//                     <th className="text-center align-middle" colSpan="2" style={{backgroundColor: "#CFE2FF"}}>가격</th>
//                     <th className="text-center align-middle" rowSpan="2"
//                         style={{width: '130px', backgroundColor: "#CFE2FF"}}>주문일자
//                     </th>
//                   </tr>
//                   <tr>
//                     <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>부품
//                       Code
//                     </th>
//                     <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>부품명
//                     </th>
//                     <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>수량
//                     </th>
//                     <th className="text-center align-middle" style={{width: '130px', backgroundColor: "#CFE2FF"}}>비용
//                     </th>
//                   </tr>
//                   </thead>
//                   <tbody>
